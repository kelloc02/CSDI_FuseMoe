...
def loadBert(args,device):
    if args.model_name!=None:
        if args.model_name== 'BioBert':
            ...
            tokenizer = AutoTokenizer.from_pretrained("/playpen-shared/kechengli/workspace/Fusemoe/FuseMoE/pretrain/Clinical-Longformer") 
            BioBert= AutoModel.from_pretrained("/playpen-shared/kechengli/workspace/Fusemoe/FuseMoE/pretrain/Clinical-Longformer") 
